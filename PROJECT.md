...
|---|------|-------|-------------|--------|
| M1 | Presentation Generator Implementation | Implement `generate_deck.js` to build all 8 slides with native PowerPoint objects, embedded pictures, mixed sandwich styling, and speaker notes | none | DONE |
| M2 | Verification & E2E Acceptance | Run office validation (`validate.py`), content extraction (`markitdown`), criteria audit, and forensic integrity audit | M1 | DONE |
