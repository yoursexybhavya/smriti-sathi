...
export default function RecogniseResult({
  ...
  const getMessage = () => {
    if (accuracy === 100) {
      return 'Outstanding! You got all answers correct!';
    } else if (accuracy >= 80) {
      return `Well done! You answered ${correctCount} of ${totalQuestions} correctly. Ready for the next level!`;
    } else if (accuracy >= 60) {
      return `Good effort! You answered ${correctCount} of ${totalQuestions} correctly.`;
    } else {
      return `Good practice! You answered ${correctCount} of ${totalQuestions} correctly.`;
    }
  };
