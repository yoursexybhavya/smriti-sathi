  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)] text-[var(--color-text)] transition-colors duration-200">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 pb-28">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start max-w-2xl mx-auto lg:max-w-none">
          
          {/* LEFT COLUMN: Cognitive Play & Core Activities (7 cols on Landscape) */}
          <div className="lg:col-span-7 space-y-6">
            
            {/* Daily Focus Hero Card */}
            <div className="p-6 sm:p-7 bg-[var(--color-card)] rounded-3xl border-2 border-[var(--color-border)] shadow-md space-y-5 transition-all">
            ...
            <div className="p-5 bg-[var(--color-card)] rounded-3xl border-2 border-[var(--color-border)] shadow-xs space-y-3 transition-colors duration-200">
              <div className="flex items-center justify-between">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-3.5">
              ...
              <div className="p-4 bg-[var(--color-card)] rounded-2xl border-2 border-[var(--color-border)] flex items-center justify-between gap-3 shadow-xs">
                ...
                <button
                  ...
                  className={`px-3.5 py-2.5 rounded-2xl text-xs font-bold transition-all active:scale-95 flex items-center gap-2 min-h-[46px] cursor-pointer border-2 ${
                    isBuzzerTesting
                ...
                {reminders.length > 0 ? (
                  reminders.map(rem => {
                    ...
                    return (
                      <div
                        key={rem.id}
                        className={`w-full p-4 bg-[var(--color-card)] rounded-2xl border-2 border-[var(--color-border)] flex items-center justify-between gap-3.5 transition-all shadow-xs ${
                      ...
                      >
                        <button
                          ...
                          className="flex items-center gap-3 min-w-0 flex-1 text-left active:scale-[0.99] transition-transform cursor-pointer"
                          aria-label={`Toggle ${rem.title}`}
                        >
                          <div className="w-12 h-12 rounded-2xl bg-[var(--color-bg-subtle)] border border-[var(--color-border)] flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="p-6 bg-[var(--color-card)] rounded-3xl border-2 border-[var(--color-border)] text-center space-y-3 shadow-xs">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl bg-emerald-500/15 text-emerald-700 dark:text-emerald-300 border-2 border-emerald-500/30 text-sm font-bold hover:bg-emerald-500/25 transition-all cursor-pointer min-h-[48px]"
                    >
                      <Plus size={16} />
            ...
            <div className="p-5 sm:p-6 bg-[var(--color-card)] rounded-3xl border-2 border-[var(--color-border)] shadow-xs space-y-4 transition-all">
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3.5 min-w-0">
                  <div className="w-12 h-12 rounded-2xl bg-indigo-50 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400 border-2 border-indigo-200 dark:border-indigo-800 flex items-center justify-center flex-shrink-0 shadow-xs">
