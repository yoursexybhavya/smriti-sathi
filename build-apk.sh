...
cp app/build/outputs/apk/debug/app-debug.apk "$ROOT_DIR/SmritiSathi-v1.0.2.apk"
cp app/build/outputs/apk/debug/app-debug.apk "/Users/krishnajangid/Desktop/SmritiSathi-v1.0.2.apk"
echo ""
echo "=========================================================="
echo " ✅ Build Complete!"
echo " 📱 Native APK saved to:"
echo "    $ROOT_DIR/SmritiSathi-v1.0.2.apk"
echo "    /Users/krishnajangid/Desktop/SmritiSathi-v1.0.2.apk"
echo "=========================================================="
